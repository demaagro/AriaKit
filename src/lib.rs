...
#[derive(Debug)]
pub struct AriaKitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AriaKitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AriaKit processing");
    
    let mut processor = AriaKitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AriaKitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AriaKitProcessor::new(false);
